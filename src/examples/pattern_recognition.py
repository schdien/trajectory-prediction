...
from src.classify import gridding
import numpy as np
from src.classify.dataset import SequenceDataset
from src.classify.module import GridEncoder,SeqentialClassifier
...
dataset = SequenceDataset([trajs1,trajs2])
